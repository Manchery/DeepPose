...
ROOT=.
CUR=$ROOT/examples/deeppose_refine
...
convert_imageset_multilabel -resize_height=64 -resize_width=64 "" $CUR/train_images.txt $CUR/train_data_lmdb
...
convert_imageset_multilabel -resize_height=64 -resize_width=64 "" $CUR/test_images.txt $CUR/test_data_lmdb
